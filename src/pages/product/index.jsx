...
const Product = () => {
  ...
  useEffect(() => {
    if (productStatus === 'idle') {
      // this check ensure the product is fetched once
  ...
  return (
    <>
      {productStatus === 'loading' ? (
        <div className="w-full h-screen flex items-center justify-center">Loading The Product...</div>
        ...
        <div className="flex flex-col space-y-5 mb-5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 w-full border-[1px] border-[#E5E7EB] bg-white">
            ...
            <div className="flex flex-col">
              ...
              <MapCard lat={product.company.address.latitude} lng={product.company.address.longitude} />
            </div>
          </div>
        ...
        <div className="w-full h-screen flex items-center justify-center">{productError}</div>
      )}
    </>
  );
};
